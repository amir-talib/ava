...
export default function ContactPage() {
  ...
  const contactInfo = [
    {
      icon: <MapPin className="text-fashion-600" size={24} />,
      title: 'Visit Us',
    ...
    {
      icon: <Clock className="text-fashion-600" size={24} />,
      ...
      <section className="section-spacing bg-neutral-50">
        <div className="container-custom">
          <PageHeader
            ...
            description="Have questions about our programs, admissions, or facilities? We&apos;re here to help you begin your fashion journey."
          />
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="tour">Studio Tour Request</option>
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center space-x-4">
                  <a
                    ...
                    className="p-3 border border-neutral-300 hover:border-fashion-600 hover:text-fashion-600 transition-colors"
              ...
              <div className="bg-fashion-50 border border-fashion-200 p-6">
                <h3 className="font-semibold mb-2">Schedule a Studio Tour</h3>
                <p className="text-sm text-neutral-600 mb-4">
                  Experience our facilities firsthand and meet our faculty. Tours available Monday - Saturday.
                </p>
                <Button href="/fashion/admissions" variant="secondary">
                  Book a Tour
                </Button>
              </div>
            </motion.div>
