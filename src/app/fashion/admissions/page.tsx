...
export default function AdmissionsPage() {
  ...
  const requirements = [
    ...
    'Interview demonstrating fashion interest',
  ]

  const steps = [
    {
      icon: <FileText className="text-fashion-600" size={32} />,
      title: 'Submit Application',
      description: 'Complete the online application form with your personal details and program selection.',
    },
    {
      icon: <Calendar className="text-fashion-600" size={32} />,
      title: 'Portfolio Review',
      description: 'Submit your creative portfolio and attend an interview to discuss your fashion vision.',
    },
    {
      icon: <CheckCircle className="text-fashion-600" size={32} />,
      title: 'Receive Decision',
      description: 'Get your admission decision within 7 working days via email.',
    },
    {
      icon: <CreditCard className="text-fashion-600" size={32} />,
  ...
  const programs = [
    { value: 'foundation-course', label: 'Foundation Course (Beginner Level)' },
    { value: 'intermediate-course', label: 'Intermediate Course (Mid-Level Skills)' },
    { value: 'advanced-course', label: 'Advanced Course (Professional Mastery)' },
  ]
    ...
    <div>
      ...
      <section className="section-spacing bg-neutral-50">
        <div className="container-custom">
          <PageHeader
            subtitle="Admissions"
            title="Begin Your Fashion Journey"
            description="Join Nigeria's premier fashion institution. Applications are rolling—apply today and start transforming your creative vision into reality."
          />
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-lg text-neutral-600">
              Our streamlined admissions process ensures you can focus on what matters—your fashion education.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="mb-2 text-sm font-medium text-fashion-600">
                  Step {index + 1}
                </div>
              ...
              <ul className="space-y-4">
                {requirements.map((req) => (
                  <li key={req} className="flex items-start">
                    <Check className="text-fashion-600 mr-3 flex-shrink-0" size={24} />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-neutral-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-fashion-600 focus:border-transparent"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium mb-2">
                    Tell Us About Your Fashion Vision (Optional)
                  </label>
                  <textarea
                    id="message"
                    rows={4}
                    ...
                    className="w-full px-4 py-3 border border-neutral-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-fashion-600 focus:border-transparent"
                    placeholder="Share your passion for fashion and what you hope to achieve..."
                  />
                </div>
      ...
      <section className="section-spacing bg-fashion-600 text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button href="/fashion/faq" className="bg-white text-fashion-600 hover:bg-neutral-50">
              View FAQ
            </Button>
            <Button href="/fashion/contact" variant="secondary" className="border-white text-white hover:bg-white/10">
              Contact Admissions
            </Button>
          </div>
        </div>
