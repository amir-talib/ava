...
export default function CoursesPage() {
  const courses = [
    ...
    },
    {
      ...
      description: 'Comprehensive baking program covering breads and pastries. Training includes: texture mastery, flavor development, and design techniques. Step-by-step hands-on training with expert instructors. Focus on turning simple ingredients into professional creations.',
      curriculum: [
        'Texture mastery',
        'Flavor development',
        'Design techniques',
