...
export default function AboutPage() {
  const values = [
    {
      icon: <Award className="text-culinary-600" size={40} />,
      title: 'Excellence',
      description: 'Highest standards in training and professionalism.',
    },
    {
      icon: <Target className="text-culinary-600" size={40} />,
      title: 'Creativity',
      description: 'Innovation and artistic expression.',
    },
    {
      icon: <Globe className="text-culinary-600" size={40} />,
      title: 'Integrity',
      description: 'Honesty, responsibility, and ethical conduct.',
    },
    {
      icon: <Heart className="text-culinary-600" size={40} />,
      title: 'Discipline',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <Image
                ...
                alt="Ace Vocational Academy Culinary Facilities"
                fill
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-display-sm font-display font-semibold mb-6">Our Mission</h2>
            ...
            >
              <h2 className="text-display-sm font-display font-semibold mb-6">Our Vision</h2>
              <p className="text-lg text-neutral-600 leading-relaxed">
            ...
            {[
              ...
              >
                <div className="flex items-start">
                  <Check className="text-culinary-600 mr-3 flex-shrink-0 mt-1" size={20} />
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Be part of our founding community and help shape the future of culinary education. Your journey starts here.
            </p>
